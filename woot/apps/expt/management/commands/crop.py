...
class Command(BaseCommand):
	...
	def handle(self, *args, **options):
		...
		if experiment_name!='' and series_name!='':
			...
			tracks = []
			for file_name in [f for f in os.listdir(experiment.track_path) if ('.xls' in f and 'crop' in f)]:
			...
			csv_file_name = '{}_s{}_{}_crop.csv'.format(experiment_name, series_name, random_string())
